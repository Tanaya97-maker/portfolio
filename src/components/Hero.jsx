    ...
    <header className="hero reveal">
      <div className="hero-container">
        <div className="hero-content ">
          <div className="hero-eyebrow">Software Developer | React Developer | React.js • Node.js • PostgreSQL | AI Automation | UI/UX Design</div>
        ...
        <div className="hero-media">
          <img src="/gif.webp" alt="Coding GIF" className="hero-gif" />
        </div>
      </div>
    </header>
  );
