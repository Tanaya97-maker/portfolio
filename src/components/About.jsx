    ...
    <section id="about" className="reveal">
      ...
      <div className="about-grid">
        <div className="about-text">
          ...
          <p>
            Beyond web dev, I've been building <strong>AI automation workflows</strong> — email agents, call qualification systems, inventory assistants — using tools like n8n, Make.com, Zapier, and AI APIs.
          </p>
          <p>
        ...
        <div className="about-stats">
          ...
          <div className="stat-card reveal">
            ...
            <div className="stat-label">Final year project - ML model accuracy</div>
          </div>
          <div className="stat-card reveal">
            <div className="stat-number">1</div>
            <div className="stat-label">AI automation projects</div>
          </div>
          <div className="stat-card reveal">
